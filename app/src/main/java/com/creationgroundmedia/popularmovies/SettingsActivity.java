...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getFragmentManager().beginTransaction()
                .replace(R.id.settings_container, new MovieListSizePreferenceFragment())
                .commit();

    }

    /**
     * the rest of the code is copied from Android Studio generated Settings Activity
     */
    public static class MovieListSizePreferenceFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_movie_list_size);
